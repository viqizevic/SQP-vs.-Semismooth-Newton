function test_betts_func_with_fmincon_too()
	...
	r = [ -a; b ];
	tic;
	%[x_ssn,fval_ssn,it_ssn] = active_set_strategy('betts_func','grad_betts_func','hess_betts_func',G,r,x0,m0,itmax,tol);
	...
	tic;
	[x_fmc,fval_fmc,exitflag,output] = fmincon('betts_func',x0,[],[],[],[],a,b,[],options);
	t_fmc = toc;
	x3 = sprintf('%.3f ',x_fmc);
