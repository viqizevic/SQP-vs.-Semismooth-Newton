function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_dixon_func_1(show)
    lambda = 0.001;
    ...
    c = [ -a; b ];
    tic;
    %[x_ssn,fval_ssn,it_ssn] = active_set_strategy('dixon_func_1','grad_dixon_func_1','hess_dixon_func_1',lambda,a,b,x0,m0,itmax,tol);
    %[x_ssn,fval_ssn,it_ssn] = semismooth_newton('dixon_func_1','grad_dixon_func_1','hess_dixon_func_1',lambda,a,b,x0,itmax,tol);
    [x_ssn,fval_ssn,it_ssn] = ssn('dixon_func_1','grad_dixon_func_1','hess_dixon_func_1',lambda,A,c,x0,itmax,tol);
    t_ssn = toc;
    x1 = sprintf('%.3f ',x_ssn);
    ...
    tic;
    [x_sqp,fval_sqp,it_sqp] = seq_quad_prog('dixon_func_1_v0','grad_dixon_func_1_v0','hess_dixon_func_1_v0',A,c,x0,itmax,tol);
    t_sqp = toc;
    x2 = sprintf('%.3f ',x_sqp);
