function test_dixon_func_1_with_fmincon()
    lambda = 0.001;
    ...
    tic;
    [x_as,fval_as,exitflag,output] = fmincon('dixon_func_1_v0',x0,[],[],[],[],a,b,[],options);
    t_as = toc;
    x1 = sprintf('%.3f ',x_as);
    ...
    tic;
    [x_sqp,fval_sqp,exitflag,output] = fmincon('dixon_func_1_v0',x0,[],[],[],[],a,b,[],options);
    t_sqp = toc;
    x2 = sprintf('%.3f ',x_sqp);
