function test_dixon_func_4()
	...
	itmax = 1000;
	tic;
	[x_ssn,fval_ssn,it_ssn] = projection_newton('dixon_func_4_v0','grad_dixon_func_4_v0','hess_dixon_func_4_v0',a,b,x0,itmax,tol);
	%[x_ssn,fval_ssn,it_ssn] = projiziertes_gradientenverfahren('dixon_func_4','grad_dixon_func_4',lambda,a,b,x0,itmax,tol);
	%[x_ssn,fval_ssn,it_ssn] = active_set_strategy('dixon_func_4','grad_dixon_func_4',lambda,a,b,x0,m0,itmax,tol);
