function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_dixon_func_4(show)
    lambda = 0.001;
    a = [3; -3; 5; 3; 2];
    b = [7; 0; 5; 10; 14];
    x0 = [4; -1; 5; 4; 7];
    ...
    [x_ssn,fval_ssn,it_ssn] = ssn('dixon_func_4','grad_dixon_func_4','hess_dixon_func_4',lambda,A,c,x0,itmax,tol);
    t_ssn = toc;
    x1 = sprintf('%.3f ',x_ssn);
    ...
    tic;
    [x_sqp,fval_sqp,it_sqp] = seq_quad_prog('dixon_func_4_v0','grad_dixon_func_4_v0','hess_dixon_func_4_v0',A,c,x0,itmax,tol);
    t_sqp = toc;
    x2 = sprintf('%.3f ',x_sqp);
