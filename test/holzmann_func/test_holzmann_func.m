function test_holzmann_func()
    ...
    itmax = 200;
    tic;
    [x_ssn,fval_ssn,it_ssn] = active_set_strategy('holzmann_func','grad_holzmann_func','hess_holzmann_func',lambda,a,b,x0,m0,itmax,tol);
    ...
    c = [ -a; b ];
    tic;
    [x_sqp,fval_sqp,it_sqp] = seq_quad_prog('holzmann_func_v0','grad_holzmann_func_v0','hess_holzmann_func_v0',A,c,x0,itmax,tol);
    t_sqp = toc;
    x2 = sprintf('%.3f ',x_sqp);
