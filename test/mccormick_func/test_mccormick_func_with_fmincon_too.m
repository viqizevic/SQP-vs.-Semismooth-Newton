function test_mccormick_func_with_fmincon_too()
	...
	c = [ -a; b ];
	tic;
	[x_sqp,fval_sqp,it_sqp] = sqp('mccormick_func_v0','grad_mccormick_func_v0','hess_mccormick_func_v0',A,c,x0,itmax,tol);
	t_sqp = toc;
	x2 = sprintf('%.3f ',x_sqp);
	...
	tic;
	[x_fmc,fval_fmc,exitflag,output] = fmincon('mccormick_func_v0',x0,[],[],[],[],a,b,[],options);
	t_fmc = toc;
	x3 = sprintf('%.3f ',x_fmc);
