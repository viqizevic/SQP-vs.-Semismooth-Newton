function test_problem_A_huang_aggerwal_hs49_with_fmincon_too()
	u = [];
	v = [];
	x0 = [10; 7; 2; -3; 0.8];
	tol = 0.00001;
	...
	tic;
	[x_fmc,fval_fmc,exitflag,output] = fmincon('func_for_problem_A_huang_aggerwal_hs49',x0,G,r,A,b,[],[],[],options);
	t_fmc = toc;
	x3 = sprintf('%.3f ',x_fmc);
