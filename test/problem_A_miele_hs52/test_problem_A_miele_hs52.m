function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_problem_A_miele_hs52(show)
    u = [];
    v = [];
    x0 = [-1.5; 0.5; 2; -1; 0.5];
    tol = 0.00001;
    ...
    r = [ r; -u; v ];
    tic;
    %[x_ssn,fval_ssn,it_ssn] = active_set_strategy('func_for_problem_A_miele_hs52','grad_func_for_problem_A_miele_hs52','hess_func_for_problem_A_miele_hs52',A,b,G,r,x0,itmax,tol);
