function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_problem_G_example_with_diamond_area(show)
    ...
    r = [ r; -u; v ];
    tic;
    %[x_ssn,fval_ssn,it_ssn] = active_set_strategy('func_for_problem_G_example_with_diamond_area','grad_func_for_problem_G_example_with_diamond_area','hess_func_for_problem_G_example_with_diamond_area',A,b,G,r,x0,itmax,tol);
