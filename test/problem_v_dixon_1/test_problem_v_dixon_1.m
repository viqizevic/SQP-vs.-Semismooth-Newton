function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_problem_v_dixon_1(show)
    ...
    r = [ r; -u; v ];
    tic;
    %[x_ssn,fval_ssn,it_ssn] = active_set_strategy('func_for_problem_v_dixon_1','grad_func_for_problem_v_dixon_1','hess_func_for_problem_v_dixon_1',A,b,G,r,x0,itmax,tol);
