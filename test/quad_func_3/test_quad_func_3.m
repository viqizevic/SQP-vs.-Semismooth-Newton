function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_quad_func_3(show)
    ...
    c = [ -a; b ];
    tic;
    %[x_ssn,fval_ssn,it_ssn] = active_set_strategy('quad_func_3','grad_quad_func_3','hess_quad_func_3',lambda,A,c,x0,m0,itmax,tol);
    ...
    tic;
    [x_sqp,fval_sqp,it_sqp] = seq_quad_prog('quad_func_3_v0','grad_quad_func_3_v0','hess_quad_func_3_v0',A,c,x0,itmax,tol);
    t_sqp = toc;
    x2 = sprintf('%.3f ',x_sqp);
