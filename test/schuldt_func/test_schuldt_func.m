function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_schuldt_func(show)
    ...
    c = [ -a; b ];
    tic;
    %[x_ssn,fval_ssn,it_ssn] = active_set_strategy('schuldt_func','grad_schuldt_func','hess_schuldt_func',lambda,A,c,x0,m0,itmax,tol);
    ...
    tic;
    [x_sqp,fval_sqp,it_sqp] = seq_quad_prog('schuldt_func_v0','grad_schuldt_func_v0','hess_schuldt_func_v0',A,c,x0,itmax,tol);
    t_sqp = toc;
    x2 = sprintf('%.3f ',x_sqp);
