function test_schuldt_func_with_fmincon_too()
	...
	r = [ -a; b ];
	tic;
	%[x_ssn,fval_ssn,it_ssn] = active_set_strategy('schuldt_func','grad_schuldt_func','hess_schuldt_func',G,r,x0,m0,itmax,tol);
	...
	tic;
	[x_fmc,fval_fmc,exitflag,output] = fmincon('schuldt_func',x0,[],[],[],[],a,b,[],options);
	t_fmc = toc;
	x3 = sprintf('%.3f ',x_fmc);
