function [x_ssn,it_ssn,t_ssn,x_sqp,it_sqp,t_sqp] = test_{var_problem_name}(show)
    u = {var_u};
    v = {var_v};
    x0 = {var_x0};
    tol = {var_tol};
    ...
    r = [ r; -u; v ];
    tic;
    %[x_ssn,fval_ssn,it_ssn] = active_set_strategy('{var_function_name}','{var_grad_function_name}','{var_hess_function_name}',A,b,G,r,x0,itmax,tol);
