function test_all_with_fmincon_too()
	...
	test_dixon_2_dim_func_1_with_fmincon_too();
	disp(sprintf('\n'));
	...
	test_dixon_func_1_with_fmincon_too();
	disp(sprintf('\n'));
	disp('test_dixon_func_2');
	test_dixon_func_2_with_fmincon_too();
	disp(sprintf('\n'));
	disp('test_dixon_func_3');
	test_dixon_func_3_with_fmincon_too();
	disp(sprintf('\n'));
	disp('test_dixon_func_4');
	test_dixon_func_4_with_fmincon_too();
	disp(sprintf('\n'));
	...
	test_paviani_func_1_with_fmincon_too();
	disp(sprintf('\n'));
	disp('test_lin_regression_func');
	test_lin_regression_func_with_fmincon_too();
	disp(sprintf('\n'));
	disp('test_quad_regression_func');
	test_quad_regression_func_with_fmincon_too();
	disp(sprintf('\n'));
	disp('test_nichtlin_regression_func');
	test_nichtlin_regression_func_with_fmincon_too();
	disp(sprintf('\n'));
end