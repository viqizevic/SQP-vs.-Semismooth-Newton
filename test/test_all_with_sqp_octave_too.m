function test_all_with_sqp_octave_too()
	...
	test_problem_v_rosenbrock_1_with_sqp_octave_too(1);
	disp(sprintf('\n'));
	disp('test_problem_v_himmelblau_1');
	test_problem_v_himmelblau_1_with_sqp_octave_too(1);
	disp(sprintf('\n'));
	disp('test_problem_v_bazaraa_shetty_1');
	test_problem_v_bazaraa_shetty_1_with_sqp_octave_too(1);
	disp(sprintf('\n'));
	disp('test_problem_v_beale_1');
	test_problem_v_beale_1_with_sqp_octave_too(1);
	disp(sprintf('\n'));
	...
	test_problem_AG_opt_ctrl_with_sqp_octave_too(1);
	disp(sprintf('\n'));
end