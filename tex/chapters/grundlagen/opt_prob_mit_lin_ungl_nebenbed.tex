...
Sei $\xopt$ lokale Lösung des Problems~\eqref{eq:opmlugnb} und
...
d^T f''(\xopt) d \geq \alpha ||d||^2 \quad
  ...
  \end{cases}
\end{equation}
Dann ist $\xopt$ eine strikte lokale Lösung des Problems~\eqref{eq:opmlugnb}
\end{theorem}

Spezialfall des Problems~\eqref{eq:opmlugnb} ist das Optimierungsproblem mit
