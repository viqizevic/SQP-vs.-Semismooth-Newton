...
stationärer Punkt von $f$, wenn $\xopt$ die notwendige Bedingung~(\ref{eq:grad_zero}) erfüllt.
\end{definition}
...
Ein bekanntes Verfahren der numerischen Mathematik, um ein nichtlineares
Gleichungssystem zu lösen, ist das Newton-Verfahren.
...
Wir setzen dabei voraus, dass die Funktion $f$ zweimal differenzierbar sei.
