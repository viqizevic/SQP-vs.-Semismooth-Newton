...
% TODO Armijo-Verfahren über die Schrittweite erwähnen.
...
Der Punkt $x^{k+1}$ ist eigentlich die Lösung des Minimierungsproblems, welches
durch die quadratische Approximation von $f$ in Punkt $x^k$ definiert ist.
