...
Nun betrachten wir den Vektor $h$ und die Matrix $B$
in Schritt~\ref{list:matrix_B_in_nullraum_verfahren}.
\begin{gather}
\left(\begin{array}{c} h_1 \\ h_2 \end{array}\right)
  = -Hq
...
\end{equation}
schreiben.
Mit Hilfe dieser Gleichung bestimmen wir in
...
\end{equation}
Multiplizieren wir diese mit $H$, dann erhalten wir
\begin{equation}
