...
Es kommt nun zunächst alle Schritten des Verfahrens und
anschließend die Erklärungen des einzelnen Schrittes.
...
%-------------------------------------------------------------------------%
% Erklärung: In der Matrix H ist die Nullraum-Matrix Z gespeichert
%
...
%-------------------------------------------------------------------------%
% Erklärung: Wie eine spezielle Lösung der Gleichung Ax = b zu finden ist
%
...
Nun ergibt sich für unser Problem~\eqref{prob:quad_opt_prob_mit_lin_gl_nebenbed}
...
\end{align}
Für den Gradienten von $F$ gilt dann
\begin{equation}
...
den Multiplikator $\lambda$ berechnet.
Nach Satz~\ref{satz:notw_bed_fuer_prob_mit_lin_gl_nebenbed}
lautet die Optimalitätsbedingung des
...
\end{equation}
Aus dem oberen Teil dieses Gleichungssystems lässt sich die Gleichung
\begin{equation}
