...
Bei allen im Abschnitt~\ref{sec:testprobleme}
...
hat SSN eine bessere Leistung bezüglich der Laufzeit
...
eine geringere Anzahl von Iterationen als SSN benötigt.
...
hat SQP nur eine Iteration beansprucht.

Nur bei zwei Fällen hat SQP mehr Iterationen gebraucht,
damit die Abbruchbedingung erfüllt wurde.
Wenn man aber die Iterationen genauer betrachtet,
hätte man das Programm eigentlich schon
bei weniger Iterationen abbrechen können,
weil die berechnete Lösung da schon erreicht wurde.
