...
Die folgenden Tabelle zeigen die Ergebnisse des Tests.
...
und \#It bezeichnet die Anzahl der benötigten Iterationen.
...
\begin{tabular*}{0.75\linewidth}{@{\extracolsep{\fill}}crrrr}
  ...
  \bottomrule
\end{tabular*}
\caption{Ergebnisse der Programme für Testprobleme 1 bis 19}
\end{table}
...
\begin{tabular*}{0.75\linewidth}{@{\extracolsep{\fill}}crrrr}
  ...
  \bottomrule
\end{tabular*}
\caption{Ergebnisse der Programme für Testprobleme 20 bis 28}
\end{table}
...
\begin{tabular*}{0.75\linewidth}{@{\extracolsep{\fill}}crrrr}
  ...
  \bottomrule
\end{tabular*}
\caption{Ergebnisse der Programme für Testprobleme 29 bis 34}
\end{table}
...
\end{tikzpicture}
\caption{Laufzeiten der Programme für Testprobleme 1 bis 34}
