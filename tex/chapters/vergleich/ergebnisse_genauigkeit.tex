...
genauere Optimalwerte als SQP erzielt.
...
werden die Funktionsauswertungen der Iterationen
...
\begin{tabular*}{0.75\linewidth}{@{\extracolsep{\fill}}cll}
  \toprule
    $k$ & $f(x^k_\text{\emph{SSN}})$ & $f(x^k_\text{\emph{SSN}})$ \\
  \midrule
  ...
  \bottomrule
\end{tabular*}
\caption{Funktionsauswertungen der Iterationen bei
