...
verschiedener restringierter Optimierungsaufgaben benutzt werden können.
...
Diese Funktion kann für manche Verfahren Schwierigkeiten anbieten,
da ihr Minimum in einem schmalen "`bananenförmig"' gekrümmten Tal liegt.
...
\begin{testfunction}
(vgl. Beispiel 1.4.4 in \cite[S.~15]{alt})
\[
...
\begin{testfunction}
Dixon-Funktion (vgl. Beispiel 1.4.5 in \cite[S.~15]{alt})
\[
