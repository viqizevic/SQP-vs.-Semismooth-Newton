...
\begin{testproblem}
(Vgl. Problem 38 in \cite[S.~61]{hock})
\begin{gather}
\begin{split}
...
sind in Tabelle~\ref{tbl:messwerte_lin_regres}
zu finden.
\begin{equation*}
\xopt = (0.7, -4.3)^T
...
Die Messwerte
in Tabelle~\ref{tbl:messwerte_lin_regres}
sind zu benutzen.
\begin{equation*}
...
Die Messwerte $(\xi_i,\eta_i), i = 1,\ldots,10,$
sind in Tabelle~\ref{tbl:messwerte_nichtlin_regres}
gegeben.
\begin{equation*}
\xopt = (0.632, 0.195)^T
\quad \Rightarrow \quad
