...
\end{gather}
\begin{equation*}
x_0 = (8, 9)^T \quad\text{und}\quad \xopt = (4, 7)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (-1, 2)^T \quad\text{und}\quad \xopt = (1, 1)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (5, 5)^T \quad\text{und}\quad \xopt = (3, 2)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (5, 5)^T \quad\text{und}\quad \xopt = (2, 1)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (5, 0)^T \quad\text{und}\quad \xopt = (3, 0.5)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (5, 4)^T \quad\text{und}\quad \xopt = (0, 0)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (3, -1, -3, -1)^T \quad\text{und}\quad \xopt = (1, 1, 1, 1)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (10, \ldots, 10)^T \quad\text{und}\quad \xopt = (1, \ldots, 1)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (7, 10, 9)^T \quad\text{und}\quad \xopt = (5, 5, 7)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (2, 3)^T \quad\text{und}\quad \xopt = (1.224, 1.5)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (10, 10)^T \quad\text{und}\quad \xopt = (-2.928, 5)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (7, 5)^T \quad\text{und}\quad \xopt = (4, 2)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (5, 2, 4)^T \quad\text{und}\quad \xopt = (0.5, 1, 1)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (3, -1, -3, -1)^T \quad\text{und}\quad \xopt = (2, 3.831, 0.03, -0.178)^T.
\end{equation*}
\end{testproblem}
...
\end{gather}
\begin{equation*}
x_0 = (10, \ldots, 10)^T \quad\text{und}\quad \xopt = (2, \ldots, 2, 2.5)^T.
\end{equation*}
\end{testproblem}
